...
public class DashboardActivity extends AppCompatActivity {
        ...
        private void initializeWidgets(){
            ...
            viewScientistsCard.setOnClickListener(v -> Utlis.openActivity(DashboardActivity.this,
                    CardModel.class));
            addScientistCard.setOnClickListener(v -> Utlis.openActivity(DashboardActivity.this,
                    CRUDActivity.class));
            third.setOnClickListener(v -> Utlis.showInfoDialog(DashboardActivity.this, "YEEES",
